...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">QR</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Qr Link</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        ...
                        @foreach($query as $q)
                            <tr>
                                <td><a target="new" href="{{ $q->url_link }}">{{ $q->url_link }}</a></td>
                                <td>{{ $q->description }}</td>
                                <td class="text-center">
                                    <div class="card-body">
                                        {!! QrCode::size(100)->generate( $q->url_link ) !!}
                                    </div>

                                </td>
                                <td>
                                    <a class="btn btn-dark btn-sm" href="{{ route('qr.link.pdf',['id'=>$q->id]) }}">طباعة Qr Code</a>
                                    ...
                                    <a class="btn btn-danger btn-sm" href="{{ route('qr.link.delete',['id'=>$q->id]) }}">حذف الرابط</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('qr.link.create') }}" method="post" enctype="multipart/form-data">
