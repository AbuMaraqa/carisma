...
{{--                            <input name="peventid" type="hidden" value="{{ $id }}">--}}
                            <div class="form-group">
                                ...
                                <input required class="form-control" name="name" placeholder="ادخل اسم المستخدم" type="text">
                            </div>
                            <div class="form-group">
                                <label for="">الايميل</label>
                                <input required class="form-control" name="email" placeholder="ادخل الايميل" type="email">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select required class="form-control" name="user_level" id="">
