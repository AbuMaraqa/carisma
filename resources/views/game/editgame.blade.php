            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="{{ url('/updateGame/'.$id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $key->name }}" required class="form-control" name="name" placeholder="ادخل اسم اللعبة" type="text">
                            </div>
                            <div class="form-group">
                                <label for="">رابط اللعبة</label>
                                <input value="{{ $key->link }}" required class="form-control" name="link" placeholder="ادخل رابط اللعبة" type="text">
                            </div>
                            <div class="form-group">
                                <label for="">وصف اللعبة</label>
                                {{--                                <input required class="form-control" name="pemail" placeholder="ادخل الوصف" type="tel">--}}
                                <textarea class="form-control" placeholder="ادخل وصف اللعبة" name="description" id="" cols="30" rows="10">{{ $key->description }}</textarea>
                            </div>
