...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">royal</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ كوبون</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="row">
                            <a class="btn btn-dark btn-md m-1" href="{{ url('/couponPdf') }}">طباعة الكوبون</a>
                        </div>
